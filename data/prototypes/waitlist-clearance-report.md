...
| --- | ---: | ---: | ---: | --- |
| global | 0.5 | 0.2128 | 0/8872 | Reject |
| baseline | 4 | 0.2026 | 5549/8872 | Retain |
| capacity | 4 | 0.2060 | 4054/8872 | Reject |
| instructor | 2 | 0.2063 | 3693/8872 | Reject |
| meeting | 4 | 0.2109 | 1637/8872 | Reject |
| all | 4 | 0.2117 | 759/8872 | Reject |
...
| capacity | 2 | 0.2021 | 760/3592 | Reject |
| instructor | 2 | 0.2016 | 1059/3592 | Reject |
| meeting | 2 | 0.2057 | 227/3592 | Reject |
| all | 4 | 0.2062 | 117/3592 | Reject |

The production joint candidate is **baseline** with frozen prior weight **4**. The held-out grid's best baseline weight is **2**; changing production parameters requires a repeatable refresh. Exact smoothing is independent of the single-Class provisional result above.
...
> **Historical queue evidence: 71% ±31 pp (40–100%)**
> Estimated uncertainty width: **60 percentage points**
> Exact histories: **1** (1 favorable); broader LEC histories: **835** at **63%**
...
- Headline calculation: `(1 + 4 × 0.635) ÷ (1 + 4) = 0.708`.
