    ...
    >
      ...
      <details className="rounded-md border border-blue-200 bg-white p-3">
        ...
        <div className="mt-4 flex flex-col gap-5 text-sm text-slate-700">
          <section aria-labelledby="waitlist-summary-heading">
            <h4
              className="font-semibold text-slate-950"
              id="waitlist-summary-heading"
            >
          ...
          <section aria-labelledby="waitlist-components-heading">
            <h4
              className="font-semibold text-slate-950"
              id="waitlist-components-heading"
            >
              Per-Class evidence
            </h4>
            <ul
              ...
              {result.components.map((component) => (
                ...
                >
                  ...
                  <p>
                    ...
                    {component.historical.samples} comparable Classes cleared
                    this position; average net reduction{" "}
                    {average(component.historical.averageNetReduction)}.
                  </p>
                  <p>
                    Queue Activation:{" "}
          ...
          <section aria-labelledby="waitlist-timing-heading">
            <h4
              className="font-semibold text-slate-950"
              id="waitlist-timing-heading"
            >
            ...
            <dl className="mt-2 grid gap-2">
              ...
              <div>
                <dt>Timing method</dt>
                <dd className="font-semibold text-slate-950">
                  Queue Activation uses the first positive wait; enrollment and
                  add/drop dates use the official Registry calendar.
                </dd>
              </div>
              <div>
    ...
    <div className="flex w-full max-w-sm flex-col gap-8 text-left lg:max-w-4xl">
      <header className="text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-pretty leading-relaxed text-slate-700">
          Compare aggregate queue movement for a required Course Plan. This
